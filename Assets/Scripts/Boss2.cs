...
public class Boss2 : MonoBehaviour
{
    ...
    bool goLeft, goRight, goUp, goDown, attack1, attack2, chargeToPlayer, DropedReward, start;
    ...
    void Update()
    {
        if (!start && Vector2.Distance(transform.position, player.position) < 14.5)
        {
            start = true;
        ...
        if (attack1)
        {
            ...
            if (shootTimer <= 0)
            {
                ...
                bullet.Shoot(Vector2.down, 300, false);
